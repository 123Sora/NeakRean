...
**Jetpack Compose** គឺជាឧបករណ៍ (Toolkit) ដ៏ទំនើបរបស់ Android សម្រាប់ការកសាង UI ។ វាផ្លាស់ប្តូរពីវិធីសាស្ត្រប្រពៃណី (Traditional XML-based View System) ទៅជាវិធីសាស្ត្រ **Declarative UI** ដែលមានមូលដ្ឋានលើ Kotlin ។ Jetpack Compose ធ្វើឱ្យការសរសេរ Code សម្រាប់ UI កាន់តែសាមញ្ញ លឿន និងមានអនុភាព។
...
-   **Less Code:** ត្រូវការ Code តិចជាងដើម្បីកសាង UI ដូចគ្នា។
...
| **ការកសាង UI** | សរសេរ UI ដោយផ្ទាល់នៅក្នុង Kotlin Code       | កសាង UI នៅក្នុង XML File និង Connect ជាមួយ Code |
  ...
  quiz: [
    {
      ...
      options: [
        ...
        'ជាឧបករណ៍សម្រាប់កសាង UI របស់ Android',
        'ជា Library សម្រាប់ Networking'
      ],
      correct: 2,
      explanation: 'Jetpack Compose គឺជាឧបករណ៍ទំនើបសម្រាប់កសាង UI របស់ Android ។'
    },
    {
