  ...
  quiz: [
    ...
    },
    {
      ...
      options: [
        ...
        'ប្រើ Mobile-First approach និង最適化รูปภาพ (optimize images)',
        'ប្រើ Font ពិសេសៗជាច្រើន'
      ],
      correct: 2,
      explanation: 'ការប្រើ Mobile-First approach (ផ្ទុក CSS តិចជាងសម្រាប់ទូរស័ព្ទ) និងការ最適化รูปภาพ (ឧទាហរណ៍ កាត់បន្ថយទំហំឯកសារ) អាចជួយកែលម្អល្បឿនផ្ទុកសម្រាប់ឧបករណ៍ចល័ត។'
    },
    {
