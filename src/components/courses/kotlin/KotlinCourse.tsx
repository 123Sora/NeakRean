    ...
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <div className="bg-gradient-to-r from-teal-400 to-blue-500 rounded-2xl p-8 text-white mb-8">
        ...
        <p className="text-lg opacity-90">
          រៀនសូត្រ Kotlin និង Jetpack Compose ដើម្បីបង្កើតកម្មវិធី Android ដែលទំនើប។ 
      ...
      <div className="mt-6 bg-red-50 border border-red-200 rounded-xl p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <ul className="space-y-2 text-red-600">
              <li className="flex items-center space-x-2">
                <a href="https://www.youtube.com/playlist?list=PLuEdNLfGOtnV5C07xX0c3q2mC0Z9z3V6N" target="_blank" rel="noopener noreferrer" className="hover:underline flex items-center">
                  <span className="text-sm">Khode Academy - Kotlin Course</span>
                  <ChevronRight className="w-4 h-4 ml-1" />
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-red-600">
              <li className="flex items-center space-x-2">
                <a href="https://www.youtube.com/playlist?list=PLRKyZvuMYSIMW3-rS9VvI4bD4z3q7dK3Q" target="_blank" rel="noopener noreferrer" className="hover:underline flex items-center">
                  <span className="text-sm">Philipp Lackner - Kotlin & Jetpack Compose</span>
                  <ChevronRight className="w-4 h-4 ml-1" />
                </a>
              </li>
              <li className="flex items-center space-x-2">
                <a href="https://www.youtube.com/playlist?list=PLQkwcJG4YTCSpJ2NLhDNHWnLe2d6QIljt" target="_blank" rel="noopener noreferrer" className="hover:underline flex items-center">
                  <span className="text-sm">The Net Ninja - Kotlin Tutorial</span>
                  <ChevronRight className="w-4 h-4 ml-1" />
                </a>
              </li>
              <li className="flex items-center space-x-2">
                <a href="https://www.youtube.com/watch?v=F9UC9DY-vIU" target="_blank" rel="noopener noreferrer" className="hover:underline flex items-center">
                  <span className="text-sm">freeCodeCamp - Kotlin Course</span>
                  <ChevronRight className="w-4 h-4 ml-1" />
                </a>
              </li>
            </ul>
