        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-700">
                បង្កើតមេរៀន និងឯកសារសិក្សាជាភាសាខ្មែរឲ្យបានកាន់តែច្រើន ដើម្បីជួយសិស្សនិស្សិតកម្ពុជារៀនបច្ចេកវិទ្យាបានកាន់តែងាយស្រួល។
              </p>
            </div>
          </div>
         ...
         <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-700">
                លើកកម្ពស់ការប្រើប្រាស់ភាសាខ្មែរក្នុងការសិក្សាបច្ចេកវិទ្យា ដើម្បីរក្សាអត្តសញ្ញាណវប្បធម៌។
              </p>
            </div>
          </div>
